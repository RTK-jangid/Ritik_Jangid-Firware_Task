...
#define FLASH_REG				((FLASH_Reg_t*)FLASH)
...
#define FLASH_OPT_OPTLOCK		0
#define FLASH_OPT_OPTSTRT		1
#define FLASH_OPT_BORLEV		2
#define FLASH_OPT_WDG_SW		5
#define FLASH_OPT_nRST_STOP		6
#define FLASH_OPT_nRST_STDBY	7
#define FLASH_OPT_RDP			8
#define FLASH_OPT_nWRP			16
